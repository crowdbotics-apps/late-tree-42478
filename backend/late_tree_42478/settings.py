"""
Django settings for late_tree_42478 project.
...
ROOT_URLCONF = 'late_tree_42478.urls'
...
WSGI_APPLICATION = 'late_tree_42478.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_tree_42478 API",
    "DESCRIPTION": "API documentation for late_tree_42478 App",
    "VERSION": "v1",
}
